...
<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="treeview">
        <a href="#">
          <i class="fa fa-gg"></i> <span>Main Category </span>
      ...
      <li class="treeview">
        <a href="#">
          <i class="fa fa-gg"></i> <span>Sub Category </span>
          <i class="fa fa-angle-left pull-right"></i>
        </a>
        <ul class="treeview-menu">
      ...
      <li class="treeview">
        <a href="#">
          <i class="fa fa-gg"></i> <span>Size Option</span>
          <i class="fa fa-angle-left pull-right"></i>
        </a>
        <ul class="treeview-menu">
      ...
      <li class="treeview">
        <a href="#">
          <i class="fa fa-gg"></i> <span>Product Option</span>
          <i class="fa fa-angle-left pull-right"></i>
        </a>
        <ul class="treeview-menu">
